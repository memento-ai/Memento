...
-- The 'kind' column is a varchar(4) string that specifies the kind of mem record and is the discriminator key
...
CREATE TABLE meta(
    ...
    kind VARCHAR(4) NOT NULL CHECK (kind IN ('conv', 'doc', 'dsum', 'frag', 'func', 'res', 'syn', 'xchg')),
